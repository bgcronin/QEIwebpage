...
facts:
  ...
  "Procedure": "Topography-guided PTK on the graft surface, with anti-rejection drop cover"
  "Anaesthetic": "Eye drops; day procedure at South Brisbane Day Hospital"
  "Recovery": "Bandage lens and discomfort for several days; vision improves over months"
  "Health fund": "Therapeutic procedure: automatic private health fund cover for eligible policies"
faq:
  - q: "How long after my transplant can I have laser?"
    a: |
      The graft needs to be stable first: usually all sutures removed and the corneal shape unchanged over several months, which is typically a year or more after surgery. Your surgeon monitors the graft with topography to decide the right time.
  - q: "Is there a risk to the graft?"
    a: |
      Any procedure on a transplanted cornea carries a small risk of triggering rejection, so treatment is planned carefully and anti-rejection drops are used before and after. The laser removes only a thin layer from the surface of the graft.
  - q: "What are the alternatives?"
    a: |
      Rigid or scleral contact lenses often give excellent vision after a transplant. Selective suture removal, relaxing incisions in the graft edge and, in some cases, lens surgery are other ways to manage astigmatism. Laser is chosen when the surface irregularity is the main problem.
---
## Why astigmatism occurs after a transplant

A corneal transplant is stitched into place with very fine sutures, and as the graft heals and the sutures are removed the shape of the new cornea settles unpredictably. Many grafts end up with a large amount of astigmatism, and it is often irregular, so glasses cannot fully correct it. Rigid contact lenses may work but can be difficult to fit or tolerate over a graft.
