...
facts:
  ...
  "Procedure": "Phototherapeutic keratectomy, often topography-guided; mitomycin C may be applied to reduce haze"
  "Anaesthetic": "Eye drops; day procedure at South Brisbane Day Hospital"
  "Recovery": "Bandage lens and discomfort for 3 to 5 days; clarity improves over weeks to months"
  "Health fund": "Therapeutic procedure: automatic private health fund cover for eligible policies"
faq:
  - q: "Can laser remove any scar?"
    a: |
      No. PTK is suitable for scars in the anterior part of the cornea. Optical coherence tomography measures the depth of the scar to decide whether laser can safely reach it. Deeper scars are treated with a partial or full-thickness corneal transplant, which QEI's corneal surgeons also perform.
  - q: "Will the scar come back?"
    a: |
      Scars from a past injury or infection do not return once removed, although the eye must be protected from further injury or infection. Some surface conditions, such as Salzmann's nodules or dystrophies, can recur over years and may need repeat treatment.
  - q: "Will my vision be perfect afterwards?"
    a: |
      The goal is clearer, more comfortable vision with less glare, and better vision in glasses or contact lenses. The amount of improvement depends on how much of the scar can be removed and the regularity of the surface afterwards.
---
...
Phototherapeutic keratectomy removes the scarred tissue layer by layer with the excimer laser and smooths the underlying surface. When the scar has distorted the shape of the cornea, a topography-guided treatment is used to regularise it at the same time. A medication called mitomycin C may be applied briefly during the procedure to reduce the chance of haze forming as the cornea heals.
