...
- No prices are published on the site (practice decision, 23 September 2026): quotes are given in writing after assessment. Do not add dollar figures, payment-plan terms or inclusions to the laser pages, and do not reuse text, images or prices from the surgeons' separate refractive practice website.
