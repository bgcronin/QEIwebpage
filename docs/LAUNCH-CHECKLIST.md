...
- [ ] No prices, payment-plan terms or "what is included" lists are published, by decision of the practice. Quotes are given in writing after assessment. Keep it that way, and do not reuse text, images or prices from the surgeons' separate refractive practice website.
