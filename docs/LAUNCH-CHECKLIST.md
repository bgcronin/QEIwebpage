...
- [ ] The refractive pages were written on 23 September 2026 from published sources (manufacturer labelling, peer-reviewed studies and Australian Medicare and health fund information). Every clinical statement, figure and criterion must be reviewed by the laser surgeons before launch and the `reviewed_by` and `reviewed_on` fields completed. Specific items to confirm: the treatable ranges quoted for each procedure; the residual-bed and percentage-tissue-altered thresholds; the ICL age range (labelled 21 to 45 in Australia; the United States labelling was extended to 21 to 60 in 2026) and the statement that older patients are considered individually; the complication rates quoted; that LASIK flaps are made on the Ziemer Z8 and that treatments are planned from tomography and wavefront measurements; and the lens brands referred to on the lens exchange page.
- [ ] No prices, payment-plan terms or "what is included" lists are published, by decision of the practice. Quotes are given in writing after assessment. Keep it that way, and do not reuse text, images or prices from the surgeons' separate refractive practice website. The one exception, kept at the practice's request, is the original sentence on Dr Cronin's profile stating that he performs his refractive surgery through Focus Vision Clinic.
...
- [ ] Add QEI's own photographs of the excimer laser, the Z8, the ICL and the lens implants when available; the pages currently reuse existing clinic and theatre photographs.
